...
const users = [
  // Please add in alphabetical order of title.
  {
    ...
    description: "The app will feature a customizable calendar for users to track their meals through the week. Users will leverage Edamam's Recipe Search API to add meals, Built with React and Redux",
  ...
  {
    title: 'MyReads 📚',
    description: 'Created a bookshelf app that allows us to select and categorize books we have read, are currently reading, or want to read. The project emphasizes using React to build the application.',
